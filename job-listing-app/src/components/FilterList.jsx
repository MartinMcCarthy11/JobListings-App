...
export const FilterList = ({selectedTags, onClearTag, onClearTags, onTagSelected}) => {
        ...
        return (
            <div className={classList}>
                <ul className="skills-list skills-list--filter">
                    {selectedTags.map(x => <React.Fragment key={uuidv4(0x10)}><li onClick={onTagSelected} className="selected-skill">{x}</li><span className="selected-skill__remove-icon" onClick={() => onClearTag({x})} ><RemoveIcon/></span></React.Fragment>)}
                </ul>
